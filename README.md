...
| --- | --- | --- | --- |
| 32. [Number of Dice Rolls With Target Sum](https://leetcode.com/problems/number-of-dice-rolls-with-target-sum/description/) | [number_of_dice...sum.py](solution/number_of_dice_rolls_with_target_sum.py) | 517 | 16.4 |
